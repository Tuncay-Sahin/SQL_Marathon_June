...
Execute the database setup scripts to populate the schema and sample transactional data. 
...
Statistical Benchmarking: Implementing subqueries to compare individual transaction performance against regional means (e.g., Market Average).
...
Agility: Demonstrated a seamless pivot from retail to corporate reporting models using non-destructive schema modifications.
